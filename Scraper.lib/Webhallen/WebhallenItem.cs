...
namespace Scraper.lib.Webhallen
{
    ...
    public partial class WebhallenItem
    {
        public static WebhallenItem FromJson(string json) => JsonConvert.DeserializeObject<WebhallenItem>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this WebhallenItem self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
